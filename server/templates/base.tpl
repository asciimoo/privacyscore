...
.github-corner { border: 0; color: #f4f5f6; fill: #606c76; height: 5.2rem; position: absolute; right: 0; z-index: 99; top: 0; width: 5.2rem; }
...
.penalty_info { margin: 1em; padding: 1em; background: #f4f5f6; border: 1px solid #ddd; }
.penalty_info p { margin: 0; padding: 0.5em; }
